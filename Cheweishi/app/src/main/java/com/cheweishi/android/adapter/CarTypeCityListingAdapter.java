...
public class CarTypeCityListingAdapter extends BaseAdapter {

	private Context context;
	private List<ProvinceListing> list;
	private ProvinceListing provinceListing;
	public CarTypeCityListingAdapter(Context context, List<ProvinceListing> list) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			holder = new Holder();
			convertView = LayoutInflater.from(context).inflate(R.layout.cartype_provincecitylisting_listitems, null);
