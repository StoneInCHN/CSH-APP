...
import com.cheweishi.android.activity.MaintainOrderDetilsActivity;
...
public class MaintainListAdapter extends MyBaseAdapter<MainSellerInfo> {
    ...
    public MaintainListAdapter(List<MainSellerInfo> mData, Context mContext,
...
//		mNavigationUtil = new NavigationUtil(mContext);
    ...
    public void setData(List<MainSellerInfo> mData) {
        this.mData = mData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_maintain, null);
        ...
        final MainSellerInfo vo = mData.get(position);
...
//		}
        ...
        mHolder.tv_wash_car_pay.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                showDialog();
                // Intent intent = new
                // Intent(mContext,WashCarPayActivity.class);
...
//        intent.putParcelableArrayListExtra("list", (ArrayList<? extends Parcelable>) mData);
