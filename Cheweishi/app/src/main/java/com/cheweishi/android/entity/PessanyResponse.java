...
public class PessanyResponse extends BaseResponse {
    ...
    /**
     * msg : [{"score":2,"processingSite":"成都市公安局交通管理局第三分局","illegalContent":"机动车通过有灯控路口时，不按所需行进方向驶入导向车道的","finesAmount":100,"illegalAddress":"锦江大道与锦华路三段交叉路口","plate":"川A893VM","id":6,"illegalDate":"2016-01-29 12:53:28"}]
     * page : null
     */
