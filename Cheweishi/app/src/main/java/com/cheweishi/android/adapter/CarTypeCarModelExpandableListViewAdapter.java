...
public class CarTypeCarModelExpandableListViewAdapter extends
	...
	public void setDataChanged(List<Carobject> list) {
		this.list = list;
	}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		Log.i("zhfy", "url   = " + carType.getLogo());
		XUtilsImageLoader.getxUtilsImageLoader(context, R.drawable.repaire_img,holder.logo, API.DOWN_IMAGE_URL + carType.getLogo());
